...
<div class="login">
    ...
    <div class="login-text">
        ...
        <p>
            Please enter your username and we will send your password by email.
        </p>
        <p>
            For help please contact <br />{mailto address='admin@lhcone.geant.net' encode='javascript' note='the operations team'}.
        </p>
    </div>
    <div class="clr"></div>
</div>
