...
<div id="hd">
    ...
    <div class="background">
        ...
        <tr>
            <td width="75">&nbsp;</td>
            <td class="logo" align="left">IXP&nbsp;Manager</td>
            <td align="right">
                <a href="http://www.inex.ie/">
                    <img alt="LHCONE Logo" style="border: 0px; width: 150px; height: 101px;" src="{genUrl}/images/LHCOneLogo1.jpg" />
                </a>
            </td>
        </tr>
        </table>
