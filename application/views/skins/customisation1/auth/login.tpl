...
<div class="login">
    ...
    <div class="login-text">
        ...
        <p><strong>Welcome to LHCONE's IXP Manager!</strong></p>
        <p>For help please contact <br />{mailto address='admin@lhcone.geant.net' encode='javascript' note='the operations team'}.</p>
    </div>
    <div class="clr"></div>
</div>
